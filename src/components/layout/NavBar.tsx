    ...
    <>
      <div className={classes.root}>
        <AppBar position="static">
          ...
          {/* Links - Routing */}
          <Toolbar>
            <Typography className={classes.title} variant="h6" noWrap><Link className="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" style={{ color: 'white', textDecoration: 'inherit', paddingLeft: '15px' }} to="/test_123/" >My eCommerce <img src='./favicon.ico' alt='logo' style={{ height: "1.2em" }} /></Link></Typography>
